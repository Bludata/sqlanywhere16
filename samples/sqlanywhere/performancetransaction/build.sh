...
cpp_to_o tranthrd
cpp_to_o worklist
$CXX $CFLAGS $LDFLAGS $ODBC_LIBDIRS $LIBDIRS $OBJDIR/esqltran.o $OBJDIR/trantest.o $OBJDIR/odbctran.o $OBJDIR/tranthrd.o $OBJDIR/worklist.o -g -o $OBJDIR/trantest -ldbtasks${SQLANYVER} -ldblib${SQLANYVER} -ldbodbc${SQLANYVER} -lpthread
