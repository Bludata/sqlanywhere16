...
for target in $TARGETS; do
    ...
    odbc ) 
        c_to_o odbc
        $CC $CFLAGS $LDFLAGS $OBJDIR/mainch.o $OBJDIR/odbc.o -g -o $OBJDIR/odbc $ODBC_LIBDIRS $LIBDIRS $ODBC_LIBS
        ;;
    cur )
        sqc_to_c cur
        c_to_o cur
        $CC $CFLAGS $LDFLAGS $OBJDIR/mainch.o $OBJDIR/cur.o -g -o $OBJDIR/cur $LIBDIRS $LIBS
        ;;
    dcur )
        sqc_to_c dcur
        c_to_o dcur
        $CC $CFLAGS $LDFLAGS $OBJDIR/mainch.o $OBJDIR/dcur.o -g -o $OBJDIR/dcur $LIBDIRS $LIBS
        ;;
    * )
