...
# *********************************************************************
sqc_to_cpp fetchtst
$CXX $CFLAGS $CXXFLAGS $LDFLAGS $LIBDIRS $OBJDIR/fetchtst.cpp -g -o $OBJDIR/fetchtst -ldbtasks${SQLANYVER} -ldblib${SQLANYVER}

$CC $CFLAGS $LDFLAGS $LIBDIRS odbcfet.c -g -o $OBJDIR/odbcfet -ldbodbc${SQLANYVER}
