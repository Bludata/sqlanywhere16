...
echo \*\*\*
echo \*\*\* Perform the second recorded synchronization \(the protocol that
echo \*\*\* will be replayed\)
echo \*\*\*
dbmlsync -c dsn=remote -ot remote2.log -e "sv=MLReplayDemo;scn=on" -v+ -qc
