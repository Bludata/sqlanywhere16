...
*******************************************************************
		    ...
		    MobiLink Row-wise partitioning Sample

Purpose
-------
The sample illustrates how to implement partitioning of a table between
remote databases.

The sample shows synchronization between a consolidated database and two
remote databases.

Each database consists of two tables, holding employee and customer data. 
The synchronization scripts employe timestamp synchronization.
