...
create table ml_connection_script (
    ...
    constraint ml_c_version foreign key( version_id ) references ml_script_version,
    constraint ml_c_script foreign key( script_id ) references ml_script
)
/
...
create table ml_table_script (
    ...
    constraint ml_t_version foreign key( version_id ) references ml_script_version,
    constraint ml_t_table foreign key( table_id ) references ml_table,
    constraint ml_t_script foreign key( script_id ) references ml_script
)
/
