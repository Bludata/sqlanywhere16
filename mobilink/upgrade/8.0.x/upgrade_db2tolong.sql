...
insert into ml_connection_script ( version_id, event, script_id )
    select version_id, event, script_id
    from ml_connection_scri
~
...
--
-- Replace Mobilink system stored procedures.
--
...
drop procedure ml_add_lang_connec
~
...
drop procedure ml_add_java_connec
~
...
drop procedure ml_add_dnet_connec
~
...
drop procedure ml_add_lang_table_
~
...
drop procedure ml_add_java_table_
~
...
drop procedure ml_add_dnet_table_
~
