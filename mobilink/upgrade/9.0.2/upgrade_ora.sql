...
insert into ml_subscription_temp ( rid, progress, user_id,
				    last_upload_time, last_download_time )
    select user_id, commit_state, user_id,
	   last_upload_time, last_download_time
...
where component_name = 'SIS' and
    ...
    cast( property_value as varchar(512) ) = 'ROGERS AT\&T'
/
...
--
alter table ml_listening rename to ml_listening_temp
/
alter table ml_listening_temp drop constraint ml_l_dn
/
alter table ml_device_address rename to ml_device_address_temp
/
alter table ml_device_address_temp drop constraint ml_da_dn
/
alter table ml_device rename to ml_device_temp
/
...
insert into ml_device_address(device_name,medium,address,active,last_modified,ignore_tracking,source)
    select device_name,medium,address,active,last_modified,ignore_tracking,source from ml_device_address
/
...
-- ml_qa_clients may have been added previously in 9.0.2 as a performance
-- enhancement.

begin
    execute immediate 'drop table ml_qa_clients';
exception
