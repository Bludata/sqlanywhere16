...
--
-- Populate the ml_user and ml_database tables.
--
...
where component_name = 'SIS' and
    ...
    VARCHAR(property_value) = 'ROGERS AT&T'
~
...
drop procedure ml_set_listening_nt
~
...
~
drop procedure ml_set_device_nt
~
...
~
drop procedure ml_set_device_address_nt
~
