...
typedef enum {
    ...
    STREAM_ERROR_TCP_INSTEAD_OF_HTTP                                 = 280,
    STREAM_ERROR_ENCRYPTED_INSTEAD_OF_HTTP                           = 281,
    STREAM_ERROR_E2EE_INSTEAD_OF_HTTP                                = 282,
    STREAM_ERROR_TCP_INSTEAD_OF_ENCR                                 = 283,
    STREAM_ERROR_HTTP_INSTEAD_OF_ENCR                                = 284,
    STREAM_ERROR_E2EE_INSTEAD_OF_ENCR                                = 285,
    STREAM_ERROR_OUT_OF_ORDER_HTTP_REQUEST                           = 286,
    STREAM_ERROR_BAD_PRIVATE_KEY_PASSWORD                            = 287,
    STREAM_ERROR_HTTP_HEADERS_TOO_BIG                                = 288,
